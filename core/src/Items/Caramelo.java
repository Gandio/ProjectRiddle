...
public class Caramelo extends Objeto{
	 ...
	 * @param game
	 */
	public Caramelo(TheHouseOfCrimes game) {
		super(game);
		...
		if(TheHouseOfCrimes.SUSPENSE_AMBIENTE)
			textura = new Texture(Gdx.files.internal("Imagenes/ObjetosSinCon/carameloSinCon.png"));
		else
			textura = new Texture(Gdx.files.internal("Imagenes/ObjetosSinSin/carameloSinSin.png"));
