...
//Esto tiene toda la pinta de interfaz, habrá que modificarlo cuando todo funcione
public class Estado {
	...
	public Estado(int numEstado){
		...
		if(numEstado == 1 || numEstado == 3){//Puzzles de decision
			idPuzzle = 0;
			Element puzzle = child.getChild(idPuzzle);
			...
			//Estoy hay que modificarlo para que sirva para la versión con suspense
			//solo hay un puzzle de combinacion
